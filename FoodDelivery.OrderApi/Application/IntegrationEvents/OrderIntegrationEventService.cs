...
{
    public class OrderIntegrationEventService(IEventBus eventBus,
    OrderingContext orderingContext,
    IIntegrationEventLogService integrationEventLogService,
    ILogger<OrderIntegrationEventService> logger
    ) 
        : IOrderIntegrationEventService
    {
        ...
        private readonly ILogger<OrderIntegrationEventService> _logger = logger ?? throw new ArgumentNullException(nameof(logger));
