...
{
    public class DeliveryIntegrationEventService(IEventBus eventBus,
    DeliveryContext orderingContext,
    IIntegrationEventLogService integrationEventLogService,
    ILogger<DeliveryIntegrationEventService> logger
    ) 
        : IDeliveryIntegrationEventService
    {
        private readonly IEventBus _eventBus = eventBus ?? throw new ArgumentNullException(nameof(eventBus));
        private readonly DeliveryContext _orderingContext = orderingContext ?? throw new ArgumentNullException(nameof(orderingContext));
        ...
        private readonly ILogger<DeliveryIntegrationEventService> _logger = logger ?? throw new ArgumentNullException(nameof(logger));
