...
global using FoodDelivery.Identity.API;
global using FoodDelivery.Identity.API.Configuration;
global using FoodDelivery.Identity.API.Data;
global using FoodDelivery.Identity.API.Models;
global using FoodDelivery.Identity.API.Services;
...
global using Polly;
global using FoodDelivery.ServiceDefaults;
